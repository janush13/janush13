...
- Coordinated and executed 10+ events.
- Maintained transparency in organizational funds.
...
- Developed features for an AI-powered HR platform.
- Worked on resume screening, interview tracking,
and candidate assessment modules.
- Improved frontend components and user experience.
- Collaborated with a 10-member Agile team.
